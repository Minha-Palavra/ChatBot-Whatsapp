...
export const getTicketStateProcessor: Record<TicketState, IMessageState> = {
  ...
  [TicketState.WAITING_SERVICE_ADDRESS_CONFIRMATION]: new ServiceAddressInputState(),
  [TicketState.WAITING_SERVICE_DETAILS]: new ServiceDetailsInputState(),
  [TicketState.WAITING_SERVICE_DETAILS_CONFIRMATION]: new ServiceDetailsInputState(),
  [TicketState.WAITING_SERVICE_START_DATE]: new ServiceStartDateInputState(),
  [TicketState.WAITING_SERVICE_START_DATE_CONFIRMATION]: new ServiceStartDateInputState(),
  [TicketState.WAITING_SERVICE_END_DATE]: new ServiceEndDateInputState(),
  [TicketState.WAITING_SERVICE_END_DATE_CONFIRMATION]: new ServiceEndDateInputState(),
  [TicketState.WAITING_SERVICE_PAYMENT_AMOUNT]: new ServicePaymentAmountInputState(),
  [TicketState.WAITING_SERVICE_PAYMENT_AMOUNT_CONFIRMATION]: new ServicePaymentAmountInputState(),
  [TicketState.WAITING_SERVICE_PAYMENT_DATES]: new ServicePaymentDatesInputState(),
  [TicketState.WAITING_SERVICE_PAYMENT_DATES_CONFIRMATION]: new ServicePaymentDatesInputState(),
  [TicketState.WAITING_SERVICE_MATERIAL_DATE]: new ServiceMaterialDateInputState(),
  [TicketState.WAITING_SERVICE_MATERIAL_DATE_CONFIRMATION]: new ServiceMaterialDateInputState(),
  [TicketState.WAITING_SERVICE_MATERIAL_HOW_BUY]: new ServiceMaterialHowBuyInputState(),
  [TicketState.WAITING_SERVICE_MATERIAL_HOW_BUY_CONFIRMATION]: new ServiceMaterialHowBuyInputState(),
