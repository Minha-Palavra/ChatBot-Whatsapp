...
export class OtherInInstallmentsPaymentMethodState extends MessageState {
  public prefix = 'OTHER_IN_INSTALLMENTS_PAYMENT_METHOD';
  ...
  public async onStateBegin(
    ...
    await this.whatsAppService.ticketService.save({
      ...ticket,
      paymentMethod: null,
      state: TicketState.OTHER_IN_INSTALLMENTS_PAYMENT_METHOD_DESCRIPTION,
    });

    await this.whatsAppService.sendMessage(
      phoneNumber,
      messages.OTHER_IN_INSTALLMENTS_PAYMENT_METHOD_REQUEST(),
    );
  }
    ...
    for (const message of value.messages) {
      ...
      if (
        ...
        await this.whatsAppService.sendConfirmationOptions(
          phoneNumber,
          messages.OTHER_IN_INSTALLMENTS_PAYMENT_METHOD_CONFIRMATION_REQUEST(
