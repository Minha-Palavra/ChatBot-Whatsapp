...
export class MaterialsWhoWillBuyState extends MessageState {
    ...
    for (const message of value.messages) {
      ...
      if (
        ...
        context.logger.error(
          `${selectedOption} is not a valid option for ${prefix.MATERIAL_WHO_WILL_BUY}.`,
        );
      ...
      if (selectedOption === `${prefix.MATERIAL_WHO_WILL_BUY}-provider`) {
