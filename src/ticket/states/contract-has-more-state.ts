...
export class ContractHasMoreState extends MessageState {
  public async processMessages(
    ...
    for (const message of value.messages) {
      ...
      if (!this.optionHasPrefix(selectedOption, prefix.CONTRACT_HAS_MORE)) {
        context.logger.error(
          `${selectedOption} is not a valid option for ${prefix.CONTRACT_HAS_MORE}.`,
        );
