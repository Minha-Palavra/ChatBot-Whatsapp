...
export class NewTicketStates1709684531790 implements MigrationInterface {
    name = 'NewTicketStates1709684531790'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "ticket" ADD "counterpart_name" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" DROP COLUMN "counterpart_name"`);
    }
