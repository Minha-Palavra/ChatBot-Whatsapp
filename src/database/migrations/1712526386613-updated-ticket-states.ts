...
export class UpdatedTicketStates1712526386613 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" DROP COLUMN "cancellation_fee"`,
    );
    await queryRunner.query(`ALTER TABLE "ticket" DROP COLUMN "deadline_fee"`);
    await queryRunner.query(`ALTER TABLE "ticket" DROP COLUMN "payment_fee"`);
    await queryRunner.query(
      `ALTER TABLE "ticket" DROP COLUMN "payment_method"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "contract_has_cancellation_more_description" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "contract_has_deadline_more_description" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "contract_has_more_description" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "payment_method_description" character varying`,
    );
  }
}
