...
export class UpdatedTicketEntity1710167860049 implements MigrationInterface {
    name = 'UpdatedTicketEntity1710167860049'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" ADD "service_steps_description" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ticket" DROP COLUMN "service_steps_description"`);
