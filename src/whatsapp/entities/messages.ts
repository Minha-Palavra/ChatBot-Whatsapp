export const messages = {
  ...
  dataPrivacyConfirmationSuccess: 'Certo, vamos continuar!',
  requestName: 'Qual é o seu nome?',
  requestPhoneNumber: 'Agora precisamos do seu número de telefone. Por favor, digite o seu número de telefone.',
  invalidOption:
