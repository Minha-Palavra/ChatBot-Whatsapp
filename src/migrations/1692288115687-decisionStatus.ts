...
export class DecisionStatus1692288115687 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."ticket_state_enum" AS ENUM('NONE', 'INPROGRESS', 'CHOSING', 'FINISHED')`);
        await queryRunner.query(`ALTER TABLE "ticket" ADD "state" "public"."ticket_state_enum" NOT NULL DEFAULT 'NONE'`);
    }
