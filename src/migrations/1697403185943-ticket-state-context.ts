...
export class TicketStateContext1697403185943 implements MigrationInterface {
  name = 'TicketStateContext1697403185943';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."ticket_state_enum" AS ENUM('NONE', 'INPROGRESS', 'CHOSING', 'FINISHED', 'NAME', 'CONTEXT', 'TAXPAYER_NUMBER', 'EMAIL', 'JOB_DESCRIPTION', 'PAYMENT_METHOD', 'PAYMENT_AMOUNT', 'CLIENT_PHONE_NUMBER', 'CLIENT_NAME', 'CLIENT_TAXPAYER_NUMBER', 'CLIENT_EMAIL', 'CLIENT_RECIEVE', 'CLIENT_APPROVAL', 'PROPOSAL', 'SERVICE_DEADLINE', 'LGPD', 'JURISDICTION_IN_DISPUTE')`,
    );
    await queryRunner.query(
